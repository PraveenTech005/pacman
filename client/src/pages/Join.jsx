...
const Join = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-row justify-center items-center py-8">
      {!game ? (
        <form
          ...
          <div className="border w-6/12 card !p-8">
            <div className="flex space-y-3 flex-col">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p>• Type every character correctly — mistakes are counted.</p>
                <p>
            ...
            >
              ...
              <div className="flex flex-col space-y-2">
                ...
                <input
                  ...
                  onChange={(e) => {
                    setPlayerData({ ...playerData, identity: e.target.value });
                  }}
                  className="border rounded-md p-1 px-2"
                  type="text"
